...
namespace YAXLib
{
    ...
    public class YAXSerializer
    {
        ...
        /// </summary>
        private const string s_yaxLibNamespacePrefix = "yaxlib";
        ...
        /// </summary>
        private Dictionary<XNamespace, string> m_namespaceToPrefix = new Dictionary<XNamespace, string>();
        ...
        {
            RegisterNamespace(s_yaxLibNamespaceUri, s_yaxLibNamespacePrefix);
        }
            ...
            YAXCollectionAttribute collectionAttrInst)
        {
            ...
            if (collectionAttrInst != null && !String.IsNullOrEmpty(collectionAttrInst.EachElementName))
            {
                ...
                if (eachElementName.Namespace.HasNamespace())
            ...
            if (dicAttrInst != null)
            {
                ...
                if (keyAlias.Namespace.HasNamespace())
                ...
                if (valueAlias.Namespace.HasNamespace())
            ...
            foreach (object obj in dicInst)
            {
                ...
                XElement elemChild = new XElement(eachElementName, null);
        ...
        private object DeserializeBase(XElement baseElement)
        {
            ...
            var realTypeAttr = baseElement.Attribute_NamespaceSafe(s_yaxLibNamespaceUri + s_trueTypeAttrName);
            ...
            foreach (var member in GetFieldsToBeSerialized())
            {
                ...
                if (member.IsSerializedAsAttribute)
                {
                    ...
                    if (attr == null) // if the parent element does not exist
                    {
                        ...
                        if (elem != null && elem.Attribute_NamespaceSafe(s_yaxLibNamespaceUri + s_trueTypeAttrName) != null)
                        {
                ...
                else if (member.IsSerializedAsValue)
                {
                    ...
                    else
                    {
                        ...
                        if(values.Length <= 0)
                        {
                            ...
                            if (innerelem != null && innerelem.Attribute_NamespaceSafe(s_yaxLibNamespaceUri + s_trueTypeAttrName) != null)
                            {
            ...
            foreach (var member in GetFieldsToBeSerialized(typeWrapper))
            {
                ...
                if (member.IsSerializedAsAttribute)
                {
                    ...
                    else
                    {
                        ...
                        if (theElem != null && theElem.Attribute_NamespaceSafe(s_yaxLibNamespaceUri + s_trueTypeAttrName) != null)
                            return true;
                    }
                }
                else
        ...
        private void RetreiveElementValue(object o, MemberWrapper member, string elemValue, XElement xelemValue)
        {
            ...
            if (xelemValue != null)
            {
                XAttribute realTypeAttribute = xelemValue.Attribute_NamespaceSafe(s_yaxLibNamespaceUri + s_trueTypeAttrName);
        ...
        private object DeserializeCollectionValue(Type colType, XElement xelemValue, XName memberAlias, YAXCollectionAttribute colAttrInstance)
        {
            ...
            else
            {
                ...
                foreach (XElement childElem in elemsToSearch)
                {
                    ...
                    XAttribute realTypeAttribute = childElem.Attribute_NamespaceSafe(s_yaxLibNamespaceUri + s_trueTypeAttrName);
                    if (realTypeAttribute != null)
                    {
            ...
            {
                XAttribute dimsAttr = xelemValue.Attribute_NamespaceSafe(s_yaxLibNamespaceUri + s_dimsAttrName);
                int[] dims = new int[0];
                if (dimsAttr != null)
                {
            ...
            YAXCollectionAttribute colAttributeInstance, YAXDictionaryAttribute dicAttrInstance)
        {
            ...
            foreach (XElement childElem in xelemValue.Elements(eachElementName))
            {
                ...
                if (isKeyFound)
                {
                    if (isKeyAttrib)
                    {
                        key = ReflectionUtils.ConvertBasicType(childElem.Attribute_NamespaceSafe(keyAlias).Value, keyType);
                    }
                ...
                if (isValueFound)
                {
                    if (isValueAttrib)
                    {
                        value = ReflectionUtils.ConvertBasicType(childElem.Attribute_NamespaceSafe(valueAlias).Value, valueType);
                    }
        ...
        private static bool VerifyDictionaryPairElements(ref Type keyType, ref bool isKeyAttrib, ref bool isKeyContent, XName keyAlias, XElement childElem)
        {
            ...
            if (isKeyAttrib && childElem.Attribute_NamespaceSafe(keyAlias) != null)
            {
                isKeyFound = true;
            }
            ...
            else if (isKeyAttrib || isKeyContent)
            {
                ...
                if (elem != null)
                {
                    XAttribute realTypeAttr = elem.Attribute_NamespaceSafe(s_yaxLibNamespaceUri + s_trueTypeAttrName);
                    if (realTypeAttr != null)
                    {
                        Type theRealType = ReflectionUtils.GetTypeByName(realTypeAttr.Value);
                        if (theRealType != null)
