...
namespace YAXLib.KnownTypes
{
    ...
    public abstract class KnownTypeBase<T> : IKnownType
    {
        ...
        public abstract void Serialize(T? obj, XElement elem, XNamespace overridingNamespace, ISerializationContext serializationContext);
        ...
        public abstract T? Deserialize(XElement elem, XNamespace overridingNamespace, ISerializationContext serializationContext);
    }
}
