...
namespace YAXLib.KnownTypes
{
    ...
    public abstract class KnownBaseTypeBase<T> : IKnownType
    {
        ...
        /// <inheritdoc />
        void IKnownType.Serialize(object? obj, XElement elem, XNamespace overridingNamespace, ISerializationContext serializationContext)
        {
            Serialize((T?) obj, elem, overridingNamespace, serializationContext);
        }

        /// <inheritdoc />
        object? IKnownType.Deserialize(XElement elem, XNamespace overridingNamespace, ISerializationContext serializationContext)
        {
